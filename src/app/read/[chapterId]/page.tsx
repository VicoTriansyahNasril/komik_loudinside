...
import { ArrowLeft, Volume2, VolumeX, ChevronLeft, ChevronRight, ArrowUp } from 'lucide-react';
...
export default function ReaderPage({ params }: { params: { chapterId: string } }) {
  ...
  return (
    <main 
      className="min-h-screen relative transition-colors duration-300 cursor-pointer bg-black text-white"
    ...
    >
      ...
      {/* Reader Container */}
      <div className="max-w-2xl mx-auto w-full flex flex-col pb-32 min-h-screen relative z-10 bg-black shadow-[0_0_50px_rgba(255,255,255,0.05)]">
        ...
        <div className="p-8 mt-10 border-t border-zinc-800">
          <h3 className="text-center font-bold mb-6">Akhir dari {activeChapter.title}</h3>
          
          {/* Chapter Selection List */}
          <div className="mb-8">
            <h4 className="text-sm font-semibold mb-3 text-zinc-400">Pilih Chapter Lain</h4>
            <div 
            ...
            >
              {chapterList.map((ch, idx) => {
                ...
                return (
                  ...
                  >
                    {thumb && (
                      <Image src={thumb} alt={ch.title} fill className="object-cover object-top" unoptimized />
                    )}
          ...
          <div className="flex items-center justify-between gap-4">
            {prevChapter ? (
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold transition-colors bg-zinc-800 hover:bg-zinc-700 text-white"
              >
                <ChevronLeft size={20} />
            ...
            {nextChapter ? (
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg font-semibold transition-colors bg-white text-black hover:bg-zinc-200"
              >
